...
Public Class CrtinvoicedeliveryA4_Dup
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrtinvoicedeliveryA4_Dup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrtinvoicedeliveryA4_Dup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrtinvoicedeliveryA4_Dup = New CrtinvoicedeliveryA4_Dup()
        rpt.Site = Me.Site
        Return rpt
    End Function
