...
Public Class Rptrepairwithoutbill
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rptrepairwithoutbill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptrepairwithoutbill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rptrepairwithoutbill = New Rptrepairwithoutbill()
        rpt.Site = Me.Site
        Return rpt
    End Function
