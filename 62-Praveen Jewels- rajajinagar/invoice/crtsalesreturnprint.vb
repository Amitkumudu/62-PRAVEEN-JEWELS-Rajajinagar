...
Public Class crtsalesreturnprint
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crtsalesreturnprint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtsalesreturnprint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtsalesreturnprint = New crtsalesreturnprint()
        rpt.Site = Me.Site
        Return rpt
    End Function
