...
Public Class invoicecrtreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.invoice.crtreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinvoicecrtreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoicecrtreport = New invoicecrtreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
