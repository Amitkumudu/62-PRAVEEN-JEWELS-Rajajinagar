...
Public Class invoicesubrep1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.invoice.subrep1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinvoicesubrep1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoicesubrep1 = New invoicesubrep1()
        rpt.Site = Me.Site
        Return rpt
    End Function
