...
Public Class invoicerptrepJob
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.invoice.rptrepJob.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoicerptrepJob
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoicerptrepJob = New invoicerptrepJob()
        rpt.Site = Me.Site
        Return rpt
    End Function
