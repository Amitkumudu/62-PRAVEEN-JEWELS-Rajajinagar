...
Public Class invoiceduprajRptOrdernew
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "invoice.duprajRptOrdernew.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.invoice.duprajRptOrdernew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoiceduprajRptOrdernew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceduprajRptOrdernew = New invoiceduprajRptOrdernew()
        rpt.Site = Me.Site
        Return rpt
    End Function
