...
Public Class invoiceRrptbranchorder
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "invoice.Rrptbranchorder.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.invoice.Rrptbranchorder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoiceRrptbranchorder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceRrptbranchorder = New invoiceRrptbranchorder()
        rpt.Site = Me.Site
        Return rpt
    End Function
