...
Public Class CrtinvoicePrint_mrp
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrtinvoicePrint_mrp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrtinvoicePrint_mrp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrtinvoicePrint_mrp = New CrtinvoicePrint_mrp()
        rpt.Site = Me.Site
        Return rpt
    End Function
