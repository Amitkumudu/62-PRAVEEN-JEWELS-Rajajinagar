...
Public Class Crtdeliverybill_rep
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crtdeliverybill_rep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrtdeliverybill_rep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crtdeliverybill_rep = New Crtdeliverybill_rep()
        rpt.Site = Me.Site
        Return rpt
    End Function
