...
Public Class CrtschemeAdjustment_Print
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrtschemeAdjustment_Print.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrtschemeAdjustment_Print
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrtschemeAdjustment_Print = New CrtschemeAdjustment_Print()
        rpt.Site = Me.Site
        Return rpt
    End Function
