...
Public Class invoice_landscape_3
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "invoice_landscape_3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinvoice_landscape_3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoice_landscape_3 = New invoice_landscape_3()
        rpt.Site = Me.Site
        Return rpt
    End Function
